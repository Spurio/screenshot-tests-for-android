      ...
      it.args =
          mutableListOf(
              ...
              .apply {
                ...
                if (extension.openHtml) {
                  add("--open-html")
                  add("${extension.openHtml}")
                }
                ...
                add("--test_img_api")
                add(extension.recordDir)
//                add("file:///Users/denisparvadov/Downloads/screenshot-tests-for-android-master%202/sample/build/screenshotsdebugandroidtest/index.html")
