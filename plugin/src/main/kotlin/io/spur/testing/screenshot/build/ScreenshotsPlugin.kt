...
import io.spur.testing.screenshot.generated.ScreenshotTestBuildConfig
...
class ScreenshotsPlugin : Plugin<Project> {
  companion object {
    ...
    const val DEPENDENCY_GROUP = "io.spur.testing.screenshot"
  ...
  override fun apply(project: Project) {
    ...
    //screenshotExtensions.recordDir
