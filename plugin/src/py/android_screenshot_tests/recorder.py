...
class Recorder:
    def __init__(self, input, output, failure_output, html_dir):
        self._input = input
        self._output = output
    ...
    def verify(self):
        ...
        for screenshot in screenshots:
            ...
            if self._failure_output:
                ...
                shutil.copy(expected, join(self._html_dir, expected_name))
                if not self._is_image_same(expected, actual, diff):
                    ...
                    # shutil.copy(actual, join(self._html_dir, actual_name))
